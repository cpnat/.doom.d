...
- [[#swift][Swift]]
  - [[#swift-language-server][Swift Language Server]]
- [[#sql][SQL]]
  - [[#ejc-sql][EJC-SQL]]
- [[#misc][Misc]]
  - [[#pocket][Pocket]]
...
Pyright is configured by Doom through `init.el`. pyright, pylint and flake8 must be installed in the venv for lsp and flycheck to function correctly.
